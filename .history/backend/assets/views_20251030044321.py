...
def upload_asset_view(request):
    ...
    with transaction.atomic():
        ...
        # ADD: Save snapshot for initial version
        ...
        # Handle tags
        if tags_str:
            tag_names = [t.strip() for t in tags_str.split(",") for t in tag_names if t.strip()]
...
def update_asset_view(request, asset_id):
    """
    PATCH /api/assets/<id>/
    Updates asset fields and tags + creates version snapshot.
    """
